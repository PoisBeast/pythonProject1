...
class MainUi(QtWidgets.QMainWindow):
    ...
    def init_ui(self):
        ...
        self.left_username = QtWidgets.QLabel("    不知道取啥名的系统")
        ...
        self.left_button_2 = QtWidgets.QPushButton(qtawesome.icon('fa.user', color='#2c3a45'), "用户管理")
        self.left_button_2.setObjectName('left_button2')
        self.left_button_3 = QtWidgets.QPushButton(qtawesome.icon('fa.bars', color='#2c3a45'), "查询任务")
        self.left_button_3.setObjectName('left_button3')
        self.left_button_4 = QtWidgets.QPushButton(qtawesome.icon('fa.file-text', color='#2c3a45'), "实时日志")
        ...
        self.recommend_button_1.setText("Da丶dadab")  # 设置按钮文本
        self.recommend_button_1.setIcon(QtGui.QIcon('r.png'))  # 设置按钮图标
        self.recommend_button_1.setIconSize(QtCore.QSize(40, 40))  # 设置图标大小
        self.recommend_button_1.setToolButtonStyle(QtCore.Qt.ToolButtonTextUnderIcon)

        self.right_button_21 = QtWidgets.QLabel("用户")  #
        ...
        # 右边布局
        self.right_label_1 = QtWidgets.QLabel("接入状态")
        self.right_label_1.setObjectName('right_label')
        self.right_label_2 = QtWidgets.QLabel("集群状态")
        ...
        self.right_layout21.addWidget(self.right_button_22, 1, 1, 8, 1)
        ...
        self.right_layout22.addWidget(self.right_button_222, 1, 1, 8, 1)
        ...
        self.right_layout23.addWidget(self.right_button_322, 1, 1, 8, 1)
        ...
        self.right_layout24.addWidget(self.right_button_422, 1, 1, 8, 1)
        ...
        self.right_widget21.setStyleSheet(
            ...
            QWidget#right_button_21{color:#909399;font-size:15px;font-weight:500;}
            QWidget#right_button_23{color:#2c3a45;font-size:35px;font-weight:500;}
            ''')
        self.right_widget22.setStyleSheet(
            ...
            QWidget#right_button_221{color:#909399;font-size:15px;font-weight:500;}
            QWidget#right_button_223{color:#2c3a45;font-size:35px;font-weight:500;}
            ''')
        self.right_widget23.setStyleSheet(
            ...
            QWidget#right_button_321{color:#909399;font-size:15px;font-weight:500;}
            QWidget#right_button_323{color:#2c3a45;font-size:35px;font-weight:500;}
            ''')
        self.right_widget24.setStyleSheet(
            ...
            QWidget#right_button_421{color:#909399;font-size:15px;font-weight:500;}
            QWidget#right_button_423{color:#2c3a45;font-size:35px;font-weight:500;}
            ''')
