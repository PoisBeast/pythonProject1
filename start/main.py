...
"}")
    ...
    def retranslateUi(self, SplashScreen):
        ...
        self.label_title.setText(_translate("SplashScreen", "<html><head/><body><p>英雄联盟</p></body></html>"))
        self.label_description.setText(_translate("SplashScreen", "<html><head/><body><p>LOL</p></body></html>"))
        self.label_loading.setText(_translate("SplashScreen", "加载中..."))
        self.label_credits.setText(_translate("SplashScreen", "<html><head/><body><p><span style=\" font-weight:600;\">Created</span>: YYDataV</p></body></html>"))
        self.loader_window(SplashScreen)
        
    
    def loader_window(self, SplashScreen):
...
if __name__ == "__main__":
    ...
    uiSplash = Ui_SplashScreen()
    uiSplash.setupUi(mainWindow)
    mainWindow.show()
    sys.exit(app.exec_())
