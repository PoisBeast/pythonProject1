...
class MainDemo(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        self.add_new_tab(QUrl('https://u.jss.com.cn/Contents/usercenter/allow/login/login.jsp?redirecturl=dzfp&jumpurl=tHp1Fp52u91VCWLiYG_MV_yLhBgZbSkTYxFazTnEglTdwzw2TRHzFAUHNYJt_Id8VV8UGVa98upNVH524V9YOg..'), 'Homepage')
